    ...
    context '新規登録できない場合' do
      ...
      it 'お名前が空では登録できない' do
        ...
        expect(@user.errors.full_messages).to include("Last name can't be blank",
                                                      'Last name is invalid. Input full-width characters', "First name can't be blank", 'First name is invalid. Input full-width characters')
      end
      ...
      it 'お名前カナが空では登録できない' do
        ...
        expect(@user.errors.full_messages).to include("Last kana can't be blank",
                                                      'Last kana is invalid. Input full-width katakana characters', "First kana can't be blank", 'First kana is invalid. Input full-width katakana characters')
      end
